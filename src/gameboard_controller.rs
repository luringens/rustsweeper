...
impl GameboardController {
    ...
    pub fn event<E: GenericEvent>(&mut self, offset: [f64; 2], size: f64, e: &E) {
                ...
                match self.gameboard.cells[pos.1][pos.0] {
                    ...
                    CellState::HiddenBlank => {
                        ...
                        match adjacent {
                            ...
                            _ => self.gameboard.cells[pos.1][pos.0] = CellState::EmptyNumber((adjacent + 48) as char),
                        }
                    }
                    _ => { },
                }
        ...
        if let Some(Button::Mouse(MouseButton::Right)) = e.press_args() {            
            ...
            if let Some(pos) = self.get_selected_cell(offset, size) {
                match self.gameboard.cells[pos.1][pos.0] {
                    CellState::HiddenBomb => self.gameboard.cells[pos.1][pos.0] = CellState::FlaggedBomb,
                    CellState::HiddenBlank => self.gameboard.cells[pos.1][pos.0] = CellState::FlaggedBlank,
                    _ => { },
                }
            }
        }
